...
| [`check-components.py`](check-components.py) | Twenty-two rules over the pages: a page per component, an example, a demo the gallery renders, an index entry, a parameter explained, and prose written for a reader |
