...
/** Days off, and days away, for the activity calendar's marks. */
internal val publicHolidays: Set<kotlinx.datetime.LocalDate> = emptySet()
internal val flights: Map<kotlinx.datetime.LocalDate, String> = emptyMap()
